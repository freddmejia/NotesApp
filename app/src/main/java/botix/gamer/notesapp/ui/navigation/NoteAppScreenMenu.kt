...
@Composable
fun NoteAppScreenMenu(navController: NavHostController, navBarController: NavHostController, navAccountController: NavHostController, accountViewModel: AccountViewModel) {
